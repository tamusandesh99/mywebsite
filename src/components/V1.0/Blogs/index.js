        ...
        <div className="blogs-table">
          <div className="single-blog">
            <div className="blog-table-cell one">
              <button onClick={() => openInNewTab('https://wp.me/pdmxUR-1o')}>
          ...
          <div className="single-blog">
            <div className="blog-table-cell one">
              <button onClick={() => openInNewTab('https://wp.me/pdmxUR-17')}>
                What are Frameworks
              </button>
              <p>Every beginners struggles to understand what frameworks are</p>
            </div>
          </div>
          <div className="single-blog">
            <div className="blog-table-cell one">
              <button onClick={() => openInNewTab('https://wp.me/pdmxUR-1A')}>
                How are API called
              </button>
              <p>
                API is Application programming interface but how can we use them
              </p>
            </div>
          </div>
          <div className="single-blog">
          ...
          <div className="single-blog">
            <div className="blog-table-cell two">
              ...
              <p>
                MongoDB has been at the forefront of application development for
                developers
              </p>
            </div>
          </div>
          <div className="single-blog">
            <div className="blog-table-cell two">
              ...
              <p>Make contents that are useful rather than beaufiful or both</p>
            </div>
          </div>
          <div className="single-blog">
          ...
          <div className="single-blog">
            <div className="blog-table-cell three">
              <button onClick={() => openInNewTab('https://wp.me/pdmxUR-2I')}>
                The Deep End
              </button>
              <p>
                The Opposite of Rubbing Elbows. How to get back into competence
              </p>
            </div>
          </div>
        </div>
